#!/usr/bin/env bash
#
# Deterministic mock implementation of the CLI issue execution contract.
# Useful for local and CI smoke runs of scripts/ralph-run.sh.
#
...
jq -n \
  ...
  '
  {
    ...
    handoff: null,
    summary: "Mock agent completed issue successfully",
    validation_results: {
      lint: "pass",
      typecheck: "pass",
      test: "pass",
