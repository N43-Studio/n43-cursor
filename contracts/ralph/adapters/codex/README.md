...
| `create-issue` | `ralph-create-issue` |
...
- Preserve canonical `workflow_mode` semantics without adding Codex-only behavior.
...
- Codex `ralph-run` is a supported iterative runtime surface, parity-aligned with script and Cursor entrypoints.
